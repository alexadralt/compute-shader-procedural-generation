...
rdr::Shader::~Shader()
{
    ...
    if (m_spv_shader_module != nullptr) {
        spvReflectDestroyShaderModule(m_spv_shader_module.get());
    }
}
...
std::vector<SpvReflectBlockVariable*> rdr::Shader::get_push_constants() const
{
    ...
    SpvReflectResult spv_result = spvReflectEnumeratePushConstantBlocks(m_spv_shader_module.get(), &push_constants_count, nullptr);
    ...
    spv_result = spvReflectEnumeratePushConstantBlocks(m_spv_shader_module.get(), &push_constants_count, push_constants.data());
    if (spv_result != SPV_REFLECT_RESULT_SUCCESS) {
...
std::vector<SpvReflectDescriptorBinding*> rdr::Shader::get_descriptor_bindings() const
{
    ...
    SpvReflectResult spv_result = spvReflectEnumerateDescriptorBindings(m_spv_shader_module.get(), &descriptor_bindings_count, nullptr);
    if (spv_result != SPV_REFLECT_RESULT_SUCCESS) {
    ...
    spv_result = spvReflectEnumerateDescriptorBindings(m_spv_shader_module.get(), &descriptor_bindings_count, descritpor_bindings.data());
    if (spv_result != SPV_REFLECT_RESULT_SUCCESS) {
...
std::vector<SpvReflectDescriptorSet*> rdr::Shader::get_descriptor_sets() const
{
    ...
    SpvReflectResult spv_result = spvReflectEnumerateDescriptorSets(m_spv_shader_module.get(), &descriptor_sets_count, nullptr);
    if (spv_result != SPV_REFLECT_RESULT_SUCCESS) {
    ...
    spv_result = spvReflectEnumerateDescriptorSets(m_spv_shader_module.get(), &descriptor_sets_count, descritpor_sets.data());
    if (spv_result != SPV_REFLECT_RESULT_SUCCESS) {
